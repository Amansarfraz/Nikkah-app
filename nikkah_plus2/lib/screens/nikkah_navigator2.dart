...
class NikkahNavigator2 extends StatelessWidget {
  const NikkahNavigator2({super.key});
  @override
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ---------- Discover row: Replaced with Recently Viewed + underline + Saved Profile ----------
              Row(
                children: [
                  // Recently Viewed (brown)
                  const Text(
                    "Recently Viewed",
                    style: TextStyle(
